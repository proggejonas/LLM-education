  ...
  { section: "Part 08 · AutoStore Tools", color: "#0284c7",
    ...
    content: () => (
      <ToolSlide color="#0284c7" tools={[
        { icon: "🎙️", name: "Meeting transcription & summaries", access: "Teams — try it today", desc: "Every Teams meeting can be transcribed and summarised automatically. Decisions, actions, attendees — all captured without anyone taking notes." },
        { icon: "📋", name: "Custom summaries", access: "Prompt Copilot your way", desc: "Go beyond the default. Ask: \"Summarise as facilitator notes with: 1) Decisions made, 2) Actions with owner and deadline, 3) Parking lot items.\" The difference is significant." },
        { icon: "🗒️", name: "Facilitator notes", access: "Before + after meetings", desc: "Before: ask Copilot to draft an agenda and talking points. After: turn the transcript into structured notes ready to share with the team." },
        { icon: "🤖", name: "Build your own agent", access: "Microsoft Copilot Studio", desc: "Create a custom agent trained on your own documents — a team FAQ bot, an onboarding guide, a process assistant. No coding required." },
        { icon: "📓", name: "Copilot Notebook", access: "Open-ended AI workspace", desc: "Paste in a document, transcript, or raw notes and have a conversation with the content. Good for sense-making and drafting from messy inputs." },
      ]} />
    ),
    notes: "The key shift here is from 'using the default' to 'prompting for what you actually need.' The default Teams summary is fine. A prompted summary — structured as facilitator notes, with decisions and actions clearly separated — is a different and much more useful output. Encourage people to try the custom summary prompt on their very next meeting. Copilot Studio is worth mentioning for anyone who manages a process or team FAQ — you can build a working agent in an afternoon without writing code.",
  },

  { section: "Part 08 · AutoStore Tools", color: "#7c3aed",
    title: "GitHub Copilot — in the editor and in the terminal",
    content: () => (
      <ToolSlide color="#7c3aed" tools={[
        { icon: "💻", name: "Copilot in VS Code", access: "Developers", desc: "Code completions, chat grounded in your codebase, test generation, PR descriptions. AI pair programming as you write.", color: "#7c3aed" },
        { icon: "⌨️", name: "GitHub Copilot CLI", access: "Anyone with terminal access", desc: "Use 'gh copilot suggest' to generate shell commands, scripts, and automation from plain English. No need to know the syntax — just describe what you want.", color: "#7c3aed" },
        { icon: "🎨", name: "Create presentations & reports", access: "Copilot CLI", desc: "This page was built using GitHub Copilot CLI. Describe what you want to create — a dashboard, a report, a tool — and Copilot generates the scaffolding and code.", color: "#7c3aed" },
        { icon: "🛠️", name: "Build tools and software", access: "Copilot CLI + VS Code", desc: "Describe a script, tool, or automation you need. Copilot generates the implementation. Iterate in plain language until it does what you want.", color: "#7c3aed" },
      ]} />
    ),
    notes: "The important thing to highlight here is the range. GitHub Copilot isn't just for people who already write code — the CLI use case is accessible to anyone who works in a terminal. And the 'build something' use case is a good concrete example: this very presentation was created using GitHub Copilot CLI. Describe what you want, get working code, iterate. Cursor is still available for deeper agentic editing across an entire project.",
  },

  { section: "Part 08 · AutoStore Tools", color: "#d97706",
    title: "Databricks — prompting across AutoStore's datalake",
    content: () => (
      <ToolSlide color="#d97706" tools={[
        { icon: "🔍", name: "Databricks AI/BI (One)", access: "Natural language across the datalake", desc: "Prompt directly across AutoStore's entire datalake. 'What is the trend for order completion rates by region over the last 6 months?' — no SQL, no analyst required.", color: "#d97706" },
        { icon: "🗂️", name: "Genie Spaces", access: "Topic-specific AI assistants", desc: "Each Space is pre-configured for a business domain — Supply Chain, Sales, Operations. It understands the relevant tables, metrics, and terminology for that area.", color: "#d97706" },
        { icon: "💬", name: "From question to insight", access: "Business users", desc: "Type the question, Genie writes and runs the SQL, returns the result. No need to know which tables exist or how to write a query.", color: "#d97706" },
        { icon: "📈", name: "AI/BI Dashboards", access: "Smart dashboards", desc: "Dashboards where users can ask natural language follow-up questions directly in the view — drill in, filter, reframe — without going back to an analyst.", color: "#d97706" },
      ]} />
    ),
    notes: "The key message for Databricks: there are two levels. Databricks AI/BI (One) is the broad access — prompt across the entire datalake with any question. Genie Spaces go deeper — they're pre-configured for a specific topic, so they understand the domain context and give better answers for that area. Ask your data team if a Space already exists for your domain. If not, that's worth requesting — it's relatively straightforward to set up and makes a real difference to answer quality.",
  },
